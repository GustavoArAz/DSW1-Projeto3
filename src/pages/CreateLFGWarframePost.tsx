...
function CreateLFGWarframePost() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const lfgFormWarframeDB = ref(database, "lfgFormWarframe");
    const newLfgFormWarframe = push(lfgFormWarframeDB);
    set(newLfgFormWarframe, {
      title,
      nplayers,
      dsc,
    })
  ...
  return (
    <>
      <div className="container-fluid">
        <form className="post" id="lfgFormWarframe" onSubmit={handleSubmit}>
          <div className="container-fluid">
            <div className="row">
...
export default CreateLFGWarframePost;
