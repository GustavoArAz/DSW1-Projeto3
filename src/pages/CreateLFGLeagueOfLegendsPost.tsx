...
function CreateLFGLeagueOfLegendsPost() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const lfgFormLeagueOfLegendsDB = ref(database, "lfgFormLeagueOfLegends");
    const newLfgFormLeagueOfLegends = push(lfgFormLeagueOfLegendsDB);
    set(newLfgFormLeagueOfLegends, {
      title,
      nplayers,
      dsc,
    })
...
export default CreateLFGLeagueOfLegendsPost;
