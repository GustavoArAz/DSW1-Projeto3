...
function CreateLFGOverwatch2Post() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const lfgFormOverwatch2DB = ref(database, "lfgFormOverwatch2");
    const newFormLfgOverwatch2 = push(lfgFormOverwatch2DB);
    set(newFormLfgOverwatch2, {
      title,
      nplayers,
      dsc,
    })
  ...
  return (
    <>
      <div className="container-fluid">
        <form className="post" id="lfgFormOverwatch2" onSubmit={handleSubmit}>
          <div className="container-fluid">
            <div className="row">
...
export default CreateLFGOverwatch2Post;
