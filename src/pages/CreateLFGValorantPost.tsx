...
function CreateLFGValorantPost() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const lfgFormValorantDB = ref(database, "lfgFormValorant");
    const newLfgFormValorant = push(lfgFormValorantDB);
    set(newLfgFormValorant, {
      title,
      nplayers,
      dsc,
    })
  ...
  return (
    <>
      <div className="container-fluid">
        <form className="post" id="lfgFormValorant" onSubmit={handleSubmit}>
          <div className="container-fluid">
            <div className="row">
...
export default CreateLFGValorantPost;
