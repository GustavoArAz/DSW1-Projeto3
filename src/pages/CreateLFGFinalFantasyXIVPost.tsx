...
function CreateLFGFinalFantasyXIVPost() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const lfgFormFinalFantasyXIVDB = ref(database, "lfgFormFinalFantasyXIV");
    const newLfgFormFinalFantasyXIV = push(lfgFormFinalFantasyXIVDB);
    set(newLfgFormFinalFantasyXIV, {
      title,
      nplayers,
      dsc,
    })
...
export default CreateLFGFinalFantasyXIVPost;
