...
function CreateLFGDiabloIVPost() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const lfgFormDiabloIVDB = ref(database, "lfgFormDiabloIV");
    const newLfgFormDiabloIV = push(lfgFormDiabloIVDB);
    set(newLfgFormDiabloIV, {
      title,
      nplayers,
      dsc,
    })
  ...
  return (
    <>
      <div className="container-fluid">
        <form className="post" id="lfgFormDiabloIV" onSubmit={handleSubmit}>
          <div className="container-fluid">
            <div className="row">
...
export default CreateLFGDiabloIVPost;
